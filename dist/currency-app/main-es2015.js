...
/* harmony import */ var _info_info_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./info/info.component */ "./src/app/info/info.component.ts");
...
/* harmony import */ var _currency_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./currency.service */ "./src/app/currency.service.ts");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [_currency_service__WEBPACK_IMPORTED_MODULE_4__["CurrencyService"]], imports: [[
            _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"]
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"],
        _info_info_component__WEBPACK_IMPORTED_MODULE_3__["InfoComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"]] }); })();
...
/* harmony import */ var _assets_apiData_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../assets/apiData.json */ "./src/assets/apiData.json");
var _assets_apiData_json__WEBPACK_IMPORTED_MODULE_2___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../assets/apiData.json */ "./src/assets/apiData.json", 1);
...
class CurrencyService {
    ...
    // Dummy API Request
    fetchCurriencies() {
        const resp = JSON.parse(JSON.stringify(_assets_apiData_json__WEBPACK_IMPORTED_MODULE_2__));
    ...
    manipulateData(data) {
        ...
        const newQuotes = Object();
        for (let [key, value] of Object.entries(data.quotes)) {
            let keyArray = key.split(''); // getting an array of key for string manipulation for qoutes
            const itemArray = keyArray.slice(3); // getting the last 3 items from that array for currencyArray
            keyArray = itemArray.concat(keyArray); // A,E,D + U,S,D,A,E,D=A,E,D,U,S,D,A,E,D
            const newKey = keyArray.slice(0, 6).join(''); // getting the first 6 items=AEDUSA for qoutes
            const newItem = itemArray.join(''); // AED for currencyArray
    ...
    changeSource(newSourceCurrency) {
        const sourceRatio = this.currencyData.quotes[newSourceCurrency + this.currencyData.source];
        ...
        for (let [key, value] of Object.entries(this.currencyData.quotes)) {
            const keyArray = key.split(''); // getting array from keys name
            const newKey = keyArray.slice(0, 3).join('') + newSourceCurrency;
...
function InfoComponent_option_20_Template(rf, ctx) { if (rf & 1) {
...
function InfoComponent_option_25_Template(rf, ctx) { if (rf & 1) {
...
function InfoComponent_li_30_Template(rf, ctx) { if (rf & 1) {
    const _r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "li", 22);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function InfoComponent_li_30_Template_li_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8); const target_r6 = ctx.$implicit; const ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r7.onRemoveTarget(target_r6); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipe"](2, "number");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    const target_r6 = ctx.$implicit;
...
function InfoComponent_label_37_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function InfoComponent_label_37_Template_input_change_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r11); const source_r9 = ctx.$implicit; const ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r10.onSwitchSource(source_r9); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
InfoComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: InfoComponent, selectors: [["app-info"]], decls: 38, vars: 10, consts: [[1, "header"], [1, "container"], [1, "row", "text-center"], [1, "col-xs-4"], [1, "lead"], ["type", "button", 1, "btn", "btn-warning", 3, "click"], [1, "content"], [1, "col-xs-3"], ["for", "sourceArray"], ["multiple", "", "name", "sourceArray", 1, "form-control", "source", 3, "change"], ["class", "text-center", 3, "value", "selected", 4, "ngFor", "ngForOf"], ["for", "targetArray"], ["multiple", "", "name", "targetArray", 1, "form-control", "target", 3, "change"], ["class", "text-center", 3, "value", "ngClass", 4, "ngFor", "ngForOf"], [1, "col-xs-6"], [1, "list-group"], ["class", "list-group-item", 3, "click", 4, "ngFor", "ngForOf"], [1, "low-cont"], [1, "form-group"], ["class", "radio-inline", 4, "ngFor", "ngForOf"], [1, "text-center", 3, "value", "selected"], [1, "text-center", 3, "value", "ngClass"], [1, "list-group-item", 3, "click"], [1, "radio-inline"], ["type", "radio", "name", "optradio", 3, "value", "checked", "change"]], template: function InfoComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function InfoComponent_Template_button_click_11_listener() { return ctx.onUpdateData(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function InfoComponent_Template_select_change_19_listener($event) { return ctx.onChangeSource($event); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function InfoComponent_Template_select_change_24_listener($event) { return ctx.onToggleTarget($event); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](InfoComponent, [{
    ...
    }], function () { return [{ type: _currency_service__WEBPACK_IMPORTED_MODULE_1__["CurrencyService"] }]; }, null); })();
...
module.exports = __webpack_require__(/*! /home/umur/Documents/Angular/currency-app/src/main.ts */"./src/main.ts");
